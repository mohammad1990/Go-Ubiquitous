...
//                    .addOnConnectionFailedListener(this)
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                sendDataWeatherToWearable(high, low, weatherId);
    ...
    //change
    public void sendDataWeatherToWearable(double high, double low, int weatherId) {
        Log.d(LOG_TAG, "Sending info to wearable");
        ...
        putDataMapRequest.getDataMap().putAsset(KEY_ICON, createAssetFromBitmap(iconBitmap));
